...
namespace BreadPlayer.Extensions
{
        ...
        where TElement : IComparable<TElement>
    {
        ...
        public void AddItem(TElement item, bool addToElement = false)
        {
            ...
            {
                CrossPlatformHelper.Log.E("Error occured while adding file to grouped collection.", ex);
            }
        }
        /// <summary> 
        ...
        public async Task AddRange(IEnumerable<TElement> range, bool addkey = false, bool async = true)
        {
            ...
            {
                CrossPlatformHelper.Log.E("Error occured while adding range to grouped collection.", ex);
            }
        }
        protected override void OnCollectionChanged(NotifyCollectionChangedEventArgs e)
        {
            ...
            {
                CrossPlatformHelper.Log.E("Error occured while updating collection on collectionchanged.", ex);
        ...
        protected override void OnPropertyChanged(PropertyChangedEventArgs e)
        {
            ...
            {
                CrossPlatformHelper.Log.E("Error occured while updating grouped collection on property changed.", ex);
                System.Diagnostics.Debug.Write("Error Code: " + ex.HResult + ";  Error Message: " + ex.Message + "\r\n");
            }
        }
        ...
        private Grouping<TKey, TElement> FindOrCreateGroup(TKey key)
        {
            ...
            {
                CrossPlatformHelper.Log.E("Error occured while finding or creating a group.", ex);
            }
