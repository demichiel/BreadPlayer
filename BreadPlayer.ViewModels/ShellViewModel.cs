...
namespace BreadPlayer.ViewModels
{
    ...
    public class ShellViewModel : ViewModelBase
    {
        ...
        public DelegateCommand NavigateToNowPlayingViewCommand { get; set; }
        #endregion
        ...
        public async Task Load(Mediafile mp3file, bool play = false, double currentPos = 0, double vol = 50)
        {
            ...
            if (mp3file != null)
            {
                ...
                {
                    CrossPlatformHelper.Log.E("Failed to load file. Loading next file...");
                    var playingCollection = GetPlayingCollection();
